...
// Fixed rather than read from settings: these assertions are about the logic,
// so they must not change meaning when somebody edits the schedule in the app.
...
let r = describeSchedule(SCHEDULE, null, CT("2026-09-22T09:00:00Z"));
...
r = describeSchedule(SCHEDULE, null, CT("2026-09-22T11:30:00Z"));
...
r = describeSchedule(SCHEDULE, null, CT("2026-09-22T12:31:00Z"));
...
r = describeSchedule(SCHEDULE, null, CT("2026-09-22T15:31:00Z"));
...
r = describeSchedule(SCHEDULE, CT("2026-09-22T11:20:00Z"), CT("2026-09-22T15:31:00Z"));
...
r = describeSchedule(SCHEDULE, CT("2026-09-21T11:20:00Z"), CT("2026-09-22T09:00:00Z"));
...
r = describeSchedule(SCHEDULE, null, CT("2026-11-02T10:00:00Z"));
...
r = describeSchedule(SCHEDULE, null, CT("2026-11-01T05:00:00Z"));
...
r = describeSchedule(SCHEDULE, null, CT("2026-03-08T05:00:00Z"));
...
r = describeSchedule(SCHEDULE, null, CT("2026-03-08T15:00:00Z"));
...
r = describeSchedule(SCHEDULE, null, CT("2026-09-23T04:30:00Z"));
